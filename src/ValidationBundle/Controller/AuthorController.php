...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('ValidationBundle:Author')->findAll();
    ...
    {
        $author = new Author();
        $form = $this->createForm('ValidationBundle\Form\AuthorType', $author);
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('ValidationBundle\Form\AuthorType', $author);
